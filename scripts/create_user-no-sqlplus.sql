/*
Rem    NAME
Rem      create_user-no-sqlplus.sql
Rem
Rem    DESCRIPTION
Rem      Use this file to create a user / schema in which to install the logger packages (without SQL*Plus commands)
Rem
Rem    NOTES
Rem      Assumes the SYS / SYSTEM /ADMIN user is connected.
Rem
Rem    REQUIREMENTS
Rem      - Oracle 10.2+
Rem
